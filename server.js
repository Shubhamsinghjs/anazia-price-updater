...
/* ===============================
SAFE SHOPIFY FETCH (Retry + Rate Limit)
================================ */
...
async function shopifyFetch(url, options = {}, retry = 3) {
  ...
  if (res.status === 429) {
    ...
    console.log("⚠️ Shopify Rate Limit hit, waiting...");
...
console.log("Update Variant:", v.id,"| Product:",p.title,"| Price:",final);
